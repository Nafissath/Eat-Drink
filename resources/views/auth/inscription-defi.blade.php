            ...
            <div class="auth-card glass-card p-4 p-md-5">
                <div class="auth-header text-center mb-5">
                    <div class="auth-logo-wrapper mb-4"
                        ...
                        <i class="fas fa-trophy text-gold fa-2x animate-float"></i>
                    </div>
                    <h1 class="auth-title">Rejoindre le <span class="text-gold">Défi Elite Gold</span></h1>
                    <p class="auth-subtitle">Inscrivez-vous pour commencer votre quête gastronomique</p>
                </div>
                ...
                <form method="POST" action="{{ route('auth.inscription-defi.post') }}" class="luxury-form">
                    @csrf
                    <div class="row">
                        <div class="col-md-12 mb-4">
                            <div class="form-group-luxury">
                                <label for="nom_entreprise" class="form-label-luxury">Nom Complet / Pseudo de Joueur</label>
                                <div class="input-wrapper">
                                    ...
                                    <input type="text" id="nom_entreprise" name="nom_entreprise"
                                        ...
                                        value="{{ old('nom_entreprise') }}" placeholder="Ex: Jean Gourmet" required
                                        autofocus>
                                </div>
                    ...
                    <div class="d-grid mt-4 mb-4">
                        <button type="submit" class="btn-luxury-gold">
                            <span class="btn-text">S'INSCRIRE ET RELEVER LE DÉFI</span>
                            <i class="fas fa-chess-knight ms-2"></i>
                        </button>
                    </div>
                    ...
                    <div class="text-center">
                        <p class="text-white-50 small">
                            ...
                            Votre participation nécessite une validation par l'administration du festival.
                        </p>
                    </div>
                </form>

                <div class="auth-footer text-center mt-4">
                    <p class="text-white-50">Déjà inscrit ?</p>
